...
skip.describe('2 - Crie um endpoint para listar os produtos', () => {
  let connection;
  let db;
...
skip.describe('3 - Crie um endpoint para atualizar um produto', () => {
  let connection;
  let db;
...
skip.describe('4 - Crie um endpoint para deletar um produto', () => {
  let connection;
  let db;
