...
describe('2 - Crie um endpoint para listar os produtos', () => {
  ...
  skip.it('Será validado que todos produtos estão sendo retornados', async () => {
    await frisby
      .get(`${url}/products`)
      .expect('status', 200)
      .then((res) => {
  ...
  skip.it('Será validado que não é possível listar um produto que não existe', async () => {
  ...
  skip.it('Será validado que é possível listar um determinado produto', async () => {
    let result;
