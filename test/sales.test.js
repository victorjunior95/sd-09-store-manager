...
describe('6 - Crie um endpoint para listar as vendas', () => {
  ...
  skip.it('Será validado que todas as vendas estão sendo retornadas', async () => {
    let result;
    let resultProductId;
    let resultSales;
    let resultSalesId;
  ...
  skip.it('Será validado que é possível listar uma determinada venda', async () => {
    let result;
    let resultSales;
    let resultSalesId;
  ...
  skip.it('Será validado que não é possível listar uma venda inexistente', async () => {
    await frisby
      .get(`${url}/sales/9999`)
      .expect('status', 404)
      .then((responseOne) => {
...
describe('7 - Crie um endpoint para atualizar uma venda', () => {
  ...
  skip.it('Será validado que não é possível atualizar vendas com quantidade menor que zero', async () => {
    let result;
    let resultProductId;
    let resultSales;
    let resultSalesId;
  ...
  skip.it('Será validado que não é possível atualizar vendas com quantidade igual a zero', async () => {
    let result;
    let resultProductId;
    let resultSales;
    let resultSalesId;
  ...
  skip.it('Será validado que não é possível atualizar vendas com uma string no campo quantidade', async () => {
    let result;
    let resultProductId;
    let resultSales;
    let resultSalesId;
  ...
  skip.it('Será validado que é possível atualizar uma venda com sucesso', async () => {
    let result;
    let resultProductId;
    let resultSales;
    let resultSalesId;
...
describe('8 - Crie um endpoint para deletar uma venda', () => {
  ...
  skip.it('Será validado que é possível deletar uma venda com sucesso', async () => {
    let result;
    let resultSales;
    let resultProductId;
    let resultSalesId;
  ...
  skip.it('Será validado que não é possível deletar uma venda que não existe', async () => {
    await frisby
...
describe('9 - Atualize a quantidade de produtos', () => {
  ...
  skip.it('Será validado que é possível a quantidade do produto atualize ao fazer uma compra', async () => {
    let result;
  ...
  skip.it('Será validado que é possível a quantidade do produto atualize ao deletar uma compra', async () => {
    let result;
    let resultSales;
    let responseProductId;
    let responseSalesId;
...
describe('10 - Valide a quantidade de produtos', () => {
  ...
  skip.it('Será validado que o estoque do produto nunca fique com a quantidade menor que zero', async () => {
    let result;
    let responseProductId;
